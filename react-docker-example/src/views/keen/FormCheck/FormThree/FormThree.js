...
import FormThree2 from './FormThree2';
...
function FormThree() {
  ...
  const handleSubmitRadio = event => {
    //----------------image1--------------------------
    if (formik.values.image1 != '' || jobDetailData.hydroMaster.image != '') {
    ...
    if (
      ...
      jobDetailData.hydroMaster.imageBefore1 != ''
    ) {
    ...
    if (
      ...
      jobDetailData.hydroMaster.imageAfter1 != ''
    ) {
  ...
  const formik = useFormik({
    initialValues: {
      barcode: jobDetailData.hydroMaster.barcode,
      productName: jobDetailData.hydroMaster.productName,
      // product_lotno: jobDetailData.hydroMaster.productLotno,
      serialNumber: jobDetailData.hydroMaster.serialNo,

      radiogroup1: jobDetailData.hydroMaster.machineBefore1,
      radiogroup2: jobDetailData.hydroMaster.machineAfter1,
      radiogroup3: jobDetailData.hydroMaster.machineBefore2,
      radiogroup4: jobDetailData.hydroMaster.machineAfter2,
      radiogroup5: jobDetailData.hydroMaster.machineBefore3,
      radiogroup6: jobDetailData.hydroMaster.machineAfter3,
      radiogroup7: jobDetailData.hydroMaster.machineBefore4,
      radiogroup8: jobDetailData.hydroMaster.machineAfter4,
      radiogroup9: jobDetailData.hydroMaster.machineBefore5,
      radiogroup10: jobDetailData.hydroMaster.machineAfter5,
      radiogroup11: jobDetailData.hydroMaster.machineBefore6,
      radiogroup12: jobDetailData.hydroMaster.machineAfter6,
      radiogroup13: jobDetailData.hydroMaster.machineBefore71,
      radiogroup14: jobDetailData.hydroMaster.machineAfter71,
      radiogroup15: jobDetailData.hydroMaster.machineBefore72,
      radiogroup16: jobDetailData.hydroMaster.machineAfter72,
      radiogroup17: jobDetailData.hydroMaster.machineBefore73,
      radiogroup18: jobDetailData.hydroMaster.machineAfter73,
      radiogroup19: jobDetailData.hydroMaster.machineBefore8,
      radiogroup20: jobDetailData.hydroMaster.machineAfter8,
      radiogroup21: jobDetailData.hydroMaster.machineBefore9,
      radiogroup22: jobDetailData.hydroMaster.machineAfter9,
      image1: preImg,
    ...
    onSubmit: values => {
      ...
      if (
        ...
        (values.image1 != '' || jobDetailData.hydroMaster.image != '') &&
        (values.imageBefore1 != '' ||
          jobDetailData.hydroMaster.imageBefore1 != '') &&
        (values.imageAfter1 != '' ||
          jobDetailData.hydroMaster.imageAfter1 != '')
  ...
  const updateImg1 = () => {
    if (jobDetailData.hydroMaster.image == '') {
      ...
      if (preImg.length > 0) {
        const formData = new FormData();
        formData.append('ImagesId', jobDetailData.hydroMaster.image);
        formData.append('JobId', job_ID);
        formData.append('Images', imgFile);
        putImage(formData)
          .then(res => {
            ...
            setJobDetailData(prevState => ({
              ...
              hydroMaster: {
                ...prevState.hydroMaster,
                image: jobDetailData.hydroMaster.image
              }
            }));
            updateImg2();
          })
  ...
  const updateImg2 = () => {
    if (jobDetailData.hydroMaster.imageBefore1 == '') {
      const formData = new FormData();
      formData.append('JobId', job_ID);
      ...
      if (preImg2.length > 0) {
        const formData = new FormData();
        formData.append('ImagesId', jobDetailData.hydroMaster.imageBefore1);
        formData.append('JobId', job_ID);
        formData.append('Images', imgFile2);
        putImage(formData)
          .then(res => {
            ...
            setJobDetailData(prevState => ({
              ...
              hydroMaster: {
                ...prevState.hydroMaster,
                imageBefore1: jobDetailData.hydroMaster.imageBefore1
              }
            }));
            updateImg3();
          })
  ...
  const updateImg3 = () => {
    if (jobDetailData.hydroMaster.imageAfter1 == '') {
      const formData = new FormData();
      formData.append('JobId', job_ID);
      ...
      if (preImg3.length > 0) {
        const formData = new FormData();
        formData.append('ImagesId', jobDetailData.hydroMaster.imageAfter1);
        formData.append('JobId', job_ID);
        formData.append('Images', imgFile3);
        putImage(formData)
          .then(res => {
            ...
            setJobDetailData(prevState => ({
              ...
              hydroMaster: {
                ...prevState.hydroMaster,
                imageAfter1: jobDetailData.hydroMaster.imageAfter1
              }
            }));
            handleNext();
          })
  ...
  const handleNext = () => {
    updateJob(jobDetailData).then(res => {
      // if (jobDetailData.hydroMaster.status == 1) {
      //   setJobDetailData(prevState => ({
      //     ...prevState,
  ...
  const fecthData = () => {
    getJobSearch(job_ID)
      .then(res => {
        ...
        console.log(res.data.result.data.hydroMaster.productName);
        if (res.data.result.data.hydroMaster.productName.length > 0) {
          getProductSearch(res.data.result.data.hydroMaster.productName).then(
            res => {
              console.log(res);
                    ...
                    <Grid item xs={12} sm={12}>
                      ...
                      <Grid container spacing={1}>
                        <Grid item xs={12} sm={6}>
                          ...
                          {/* <TextField
                            fullWidth
                            className={handleDisableText((jobDetailData.hydroMaster.signatureCustomer.length>0)&&(jobDetailData.hydroMaster.signatureEmployee.length>0))}
                            ...
                            color="secondary"
                            size="small"
                            disabled={(jobDetailData.hydroMaster.signatureCustomer.length>0)&&(jobDetailData.hydroMaster.signatureEmployee.length>0)}
                          /> */}
                        </Grid>
                        <Grid item xs={12} sm={6}>
                          <Grid container>
                  ...
                  <Grid item xs={12} sm={12} md={2}>
                    <Grid item xs={12} sm={12} md={12}>
                      {preImg ? (
                        ...
                        <>
                          {jobDetailData.hydroMaster.image ? (
                            <img
                              src={getImgForm1(jobDetailData.hydroMaster.image)}
                              alt="dummy"
                              width="300px"
                              height="188px"
                              borderRadius="1vh"
                    ...
                    <Grid container xs={12} sm={12} md={12}>
                      ...
                      <input
                        ...
                        disabled={
                          jobDetailData.hydroMaster.signatureCustomer.length >
                            0 &&
                          jobDetailData.hydroMaster.signatureEmployee.length > 0
                        }
                      />{' '}
                      <label htmlFor="contained-button-file">
                        <Button
                          ...
                          disabled={
                            jobDetailData.hydroMaster.signatureCustomer.length >
                              0 &&
                            jobDetailData.hydroMaster.signatureEmployee.length >
                              0
                          }
                        >
                          เพิ่มไฟล์
              ...
              <Card>
                <CardContent>
                  ...
                  <Grid container>
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        >
                          {jobDetailData.hydroMaster.machineBefore1 == 1 ? (
                            <FormControlLabel
                              value={1}
                          ...
                          {jobDetailData.hydroMaster.machineBefore1 == 2 ? (
                            <FormControlLabel
                              value={parseInt(2)}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore1 == 3 ? (
                            <FormControlLabel
                              value={3}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore1 == 4 ? (
                            <FormControlLabel
                              value={4}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                    ...
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        >
                          {jobDetailData.hydroMaster.machineAfter1 == 1 ? (
                            <FormControlLabel
                              value={1}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter1 == 2 ? (
                            <FormControlLabel
                              value={2}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter1 == 3 ? (
                            <FormControlLabel
                              value={3}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter1 == 4 ? (
                            <FormControlLabel
                              value={4}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                  ...
                  <Grid container>
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        >
                          {jobDetailData.hydroMaster.machineBefore2 == 1 ? (
                            <FormControlLabel
                              value={1}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore2 == 2 ? (
                            <FormControlLabel
                              value={2}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore2 == 3 ? (
                            <FormControlLabel
                              value={3}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore2 == 4 ? (
                            <FormControlLabel
                              value={4}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                    ...
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        >
                          {jobDetailData.hydroMaster.machineAfter2 == 1 ? (
                            <FormControlLabel
                              value={1}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter2 == 2 ? (
                            <FormControlLabel
                              value={2}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter2 == 3 ? (
                            <FormControlLabel
                              value={3}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter2 == 4 ? (
                            <FormControlLabel
                              value={4}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                  ...
                  <Grid container>
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        >
                          {jobDetailData.hydroMaster.machineBefore3 == 1 ? (
                            <FormControlLabel
                              value={1}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore3 == 2 ? (
                            <FormControlLabel
                              value={2}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore3 == 3 ? (
                            <FormControlLabel
                              value={3}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore3 == 4 ? (
                            <FormControlLabel
                              value={4}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                    ...
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        >
                          {jobDetailData.hydroMaster.machineAfter3 == 1 ? (
                            <FormControlLabel
                              value={1}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter3 == 2 ? (
                            <FormControlLabel
                              value={2}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter3 == 3 ? (
                            <FormControlLabel
                              value={3}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter3 == 4 ? (
                            <FormControlLabel
                              value={4}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                  ...
                  <Grid container>
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        >
                          {jobDetailData.hydroMaster.machineBefore4 == 1 ? (
                            <FormControlLabel
                              value={1}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore4 == 2 ? (
                            <FormControlLabel
                              value={2}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore4 == 3 ? (
                            <FormControlLabel
                              value={3}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore4 == 4 ? (
                            <FormControlLabel
                              value={4}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                    ...
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        >
                          {jobDetailData.hydroMaster.machineAfter4 == 1 ? (
                            <FormControlLabel
                              value={1}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter4 == 2 ? (
                            <FormControlLabel
                              value={2}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter4 == 3 ? (
                            <FormControlLabel
                              value={3}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter4 == 4 ? (
                            <FormControlLabel
                              value={4}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                  ...
                  <Grid container>
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        >
                          {jobDetailData.hydroMaster.machineBefore5 == 1 ? (
                            <FormControlLabel
                              value={1}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore5 == 2 ? (
                            <FormControlLabel
                              value={2}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore5 == 3 ? (
                            <FormControlLabel
                              value={3}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore5 == 4 ? (
                            <FormControlLabel
                              value={4}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                    ...
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        >
                          {jobDetailData.hydroMaster.machineAfter5 == 1 ? (
                            <FormControlLabel
                              value={1}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter5 == 2 ? (
                            <FormControlLabel
                              value={2}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter5 == 3 ? (
                            <FormControlLabel
                              value={3}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter5 == 4 ? (
                            <FormControlLabel
                              value={4}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                  ...
                  <Grid container>
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        >
                          {jobDetailData.hydroMaster.machineBefore6 == 1 ? (
                            <FormControlLabel
                              value={1}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore6 == 2 ? (
                            <FormControlLabel
                              value={2}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore6 == 3 ? (
                            <FormControlLabel
                              value={3}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore6 == 4 ? (
                            <FormControlLabel
                              value={4}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                    ...
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        >
                          {jobDetailData.hydroMaster.machineAfter6 == 1 ? (
                            <FormControlLabel
                              value={1}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter6 == 2 ? (
                            <FormControlLabel
                              value={2}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter6 == 3 ? (
                            <FormControlLabel
                              value={3}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter6 == 4 ? (
                            <FormControlLabel
                              value={4}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                  ...
                  <Grid container>
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        >
                          {jobDetailData.hydroMaster.machineBefore71 == 1 ? (
                            <FormControlLabel
                              value={1}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore71 == 2 ? (
                            <FormControlLabel
                              value={2}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore71 == 3 ? (
                            <FormControlLabel
                              value={3}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore71 == 4 ? (
                            <FormControlLabel
                              value={4}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                    ...
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        >
                          {jobDetailData.hydroMaster.machineAfter71 == 1 ? (
                            <FormControlLabel
                              value={1}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter71 == 2 ? (
                            <FormControlLabel
                              value={2}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter71 == 3 ? (
                            <FormControlLabel
                              value={3}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter71 == 4 ? (
                            <FormControlLabel
                              value={4}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                  ...
                  <Grid container>
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        >
                          {jobDetailData.hydroMaster.machineBefore72 == 1 ? (
                            <FormControlLabel
                              value={1}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore72 == 2 ? (
                            <FormControlLabel
                              value={2}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore72 == 3 ? (
                            <FormControlLabel
                              value={3}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore72 == 4 ? (
                            <FormControlLabel
                              value={4}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                    ...
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        >
                          {jobDetailData.hydroMaster.machineAfter72 == 1 ? (
                            <FormControlLabel
                              value={1}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter72 == 2 ? (
                            <FormControlLabel
                              value={2}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter72 == 3 ? (
                            <FormControlLabel
                              value={3}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter72 == 4 ? (
                            <FormControlLabel
                              value={4}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                  ...
                  <Grid container>
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        >
                          {jobDetailData.hydroMaster.machineBefore73 == 1 ? (
                            <FormControlLabel
                              value={1}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore73 == 2 ? (
                            <FormControlLabel
                              value={2}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore73 == 3 ? (
                            <FormControlLabel
                              value={3}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore73 == 4 ? (
                            <FormControlLabel
                              value={4}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                    ...
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        >
                          {jobDetailData.hydroMaster.machineAfter73 == 1 ? (
                            <FormControlLabel
                              value={1}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter73 == 2 ? (
                            <FormControlLabel
                              value={2}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter73 == 3 ? (
                            <FormControlLabel
                              value={3}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter73 == 4 ? (
                            <FormControlLabel
                              value={4}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                  ...
                  <Grid container>
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        >
                          {jobDetailData.hydroMaster.machineBefore8 == 1 ? (
                            <FormControlLabel
                              value={1}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore8 == 2 ? (
                            <FormControlLabel
                              value={2}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore8 == 3 ? (
                            <FormControlLabel
                              value={3}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore8 == 4 ? (
                            <FormControlLabel
                              value={4}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                    ...
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        >
                          {jobDetailData.hydroMaster.machineAfter8 == 1 ? (
                            <FormControlLabel
                              value={1}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter8 == 2 ? (
                            <FormControlLabel
                              value={2}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter8 == 3 ? (
                            <FormControlLabel
                              value={3}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter8 == 4 ? (
                            <FormControlLabel
                              value={4}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                  ...
                  <Grid container>
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        >
                          {jobDetailData.hydroMaster.machineBefore9 == 1 ? (
                            <FormControlLabel
                              value={1}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore9 == 2 ? (
                            <FormControlLabel
                              value={2}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore9 == 3 ? (
                            <FormControlLabel
                              value={3}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineBefore9 == 4 ? (
                            <FormControlLabel
                              value={4}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                    ...
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        >
                          {jobDetailData.hydroMaster.machineAfter9 == 1 ? (
                            <FormControlLabel
                              value={1}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter9 == 2 ? (
                            <FormControlLabel
                              value={2}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter9 == 3 ? (
                            <FormControlLabel
                              value={3}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                          ...
                          {jobDetailData.hydroMaster.machineAfter9 == 4 ? (
                            <FormControlLabel
                              value={4}
                              control={handleDisableRadio(
                                jobDetailData.hydroMaster.signatureCustomer
                  ...
                  <TextField
                    ...
                    multiline
                    rows={3}
                    value={jobDetailData.hydroMaster.description}
                    onChange={handleChangeFeedBack}
                    placeholder="กรุณากรอกข้อมูล"
                    color="secondary"
                    size="small"
                    disabled={
                      jobDetailData.hydroMaster.signatureCustomer.length > 0 &&
                      jobDetailData.hydroMaster.signatureEmployee.length > 0
                    }
                    className={handleDisableText(
                      jobDetailData.hydroMaster.signatureCustomer.length > 0 &&
