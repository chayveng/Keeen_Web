...
useEffect(()=>{
console.log(props.jobDetailData.hydroMaster);
},[props.jobDetailData.hydroMaster.signatureEmployee])
  useEffect(() => {
    getJobSearch(job_ID)
      .then(res => {
        // console.log(res.data.result.data.hydroMaster);
        setImgDB(res.data.result.data.hydroMaster.image2);
        setSig1(res.data.result.data.hydroMaster.signatureCustomer);
        setSig2(res.data.result.data.hydroMaster.signatureEmployee);

        if (res.data.result.data.hydroMaster.signatureEmployee) {
          getImage(res.data.result.data.hydroMaster.signatureEmployee)
            .then(res => {
        ...
        if (res.data.result.data.hydroMaster.signatureCustomer) {
          getImage(res.data.result.data.hydroMaster.signatureCustomer)
            .then(res => {
              const result = res.data.data.images;
  ...
  const handleSubmitRadio = event => {
    ...
    if (
      ...
      props.jobDetailData.hydroMaster.product1 == 1) ||
      (formik.values.imageProduct == '' &&
        props.jobDetailData.hydroMaster.product1 == 1) ||
      (formik.values.imageProduct != '' &&
        props.jobDetailData.hydroMaster.product1 == 2) ||
      (formik.values.imageProduct == '' &&
        props.jobDetailData.hydroMaster.image2 != '')
    ) {
    ...
    if((sig1.length > 0 && sig2.length > 0) ||
      ...
      console.log("Send Email hydromaster");
    ...
    // // axios.get(host_url + "/api/v1/Todo/todo/Dbcooper From Keeenservice FormHydroMaster");
    // // axios.get(host_url + "/api/v1/Todo/todo/" + job_ID);
  };
  const formik = useFormik({
    initialValues: {
      barcode2: props.jobDetailData.hydroMaster.barcode2,
      productKeeenName: props.jobDetailData.hydroMaster.productKeeenName,
      product_lotno: props.jobDetailData.hydroMaster.productKeeenLotNo,

      radiogroup23: props.jobDetailData.hydroMaster.product1,
      radiogroup24: props.jobDetailData.hydroMaster.product2,
      radiogroup25: props.jobDetailData.hydroMaster.product3,
      radiogroup26: props.jobDetailData.hydroMaster.product4,
      radiogroup27: props.jobDetailData.hydroMaster.technicalBefore1,
      radiogroup28: props.jobDetailData.hydroMaster.technicalBefore21,
      radiogroup29: props.jobDetailData.hydroMaster.technicalAfter21,
      radiogroup30: props.jobDetailData.hydroMaster.technicalBefore22,
      radiogroup31: props.jobDetailData.hydroMaster.technicalAfter22,
      radiogroup32: props.jobDetailData.hydroMaster.technicalBefore31,
      radiogroup33: props.jobDetailData.hydroMaster.technicalBefore32,
      radiogroup34: props.jobDetailData.hydroMaster.technicalBefore33,
      imageProduct: preImg
      // sigError1formik: props.jobDetailData.hydroMaster.signatureCustomer,
      // sigError2formik: props.jobDetailData.hydroMaster.signatureEmployee,
    },
    ...
    onSubmit: values => {
      ...
      if (
        ...
        (  
          (values.imageProduct != '' && props.jobDetailData.hydroMaster.product1 == 1) ||
          (values.imageProduct == '' && props.jobDetailData.hydroMaster.product1 == 1) || 
          (values.imageProduct != '' && props.jobDetailData.hydroMaster.product1 == 2) ||
          (values.imageProduct == '' && props.jobDetailData.hydroMaster.image2 != '')
        ))
// (formik.values.imageProduct != '' &&
//       props.jobDetailData.hydroMaster.product1 == 1) ||
//       (formik.values.imageProduct == '' &&
...
//         props.jobDetailData.hydroMaster.image2 != '')
        ...
        if (props.jobDetailData.hydroMaster.product1 == 1) {
          console.log(
            'delete when have img ' + props.jobDetailData.hydroMaster.image2
          );
          console.log(props.jobDetailData.hydroMaster.product1);
          props.setJobDetailData(prevState => ({
            ...prevState,
            hydroMaster: {
              ...prevState.hydroMaster,
          ...
          handleStatus()
          setSave(true);
          if(props.jobDetailData.hydroMaster.image2){

            deleteImage(props.jobDetailData.hydroMaster.image2)
              .then(res => {
                console.log('delete');
                handleStatus()
                setSave(true);
          ...
          if (props.jobDetailData.hydroMaster.image2 == ''&& props.jobDetailData.hydroMaster.product1==2) {
              ...
              putImage(formData)
                .then(res => {
                  ...
                  props.setJobDetailData(prevState => ({
                    ...
                    hydroMaster: {
                      ...prevState.hydroMaster,
                      image2: props.jobDetailData.hydroMaster.image2
                    }
                  }));
                  handleStatus()
                  setSave(true);
  ...
  useEffect(() => {
    if (props.jobDetailData.hydroMaster.product1 == 1) {
      ...
      } else if (props.jobDetailData.hydroMaster.product1 == 2){
        if (imgNumber) {
          if (save) {
            // console.log('put img');
            // console.log('update ' + props.jobDetailData.liquidDispenser.image1);
  ...
  }, [props.jobDetailData.hydroMaster.image2, save]);
  ...
  useEffect(() => {
    ...
    if (props.jobDetailData.hydroMaster.productKeeenName.length > 0) {
      getProductSearch(props.jobDetailData.hydroMaster.productKeeenName).then(
        res => {
          console.log(res);
  ...
  const handleBack = () => {
    // if (props.jobDetailData.hydroMaster == 2) {
    //   props.setJobDetailData(prevState => ({
    //     ...prevState,
  ...
  const handleStatus = () => {
    ...
    if(props.jobDetailData.hydroMaster.signatureCustomer&& 
      props.jobDetailData.hydroMaster.signatureEmployee){
        props.setJobDetailData(prevState => ({
          ...prevState,
          ...
          ((props.jobDetailData.proSinkProMax.signatureCustomer !== '' &&
            ...
            props.jobDetailData.proSinkProMax.status == 0)
        ) {
          props.setJobDetailData(prevState => ({
            ...prevState,
            status: 2
            ...
            <Card className={classes.root} style={{ marginBottom: '15px' }}>
              <CardContent>
                    ...
                    <Grid item xs={12} sm={12} md={2}>
                      <Grid item xs={12} sm={12} md={12}>
                        {preImg ? (
                          ...
                          <>
                            {props.jobDetailData.hydroMaster.image2.length >
                            3 ? (
                              <img
                                src={getImgForm(
                                  props.jobDetailData.hydroMaster.image2
                ...
                >
                  ...
                  >
                    {props.jobDetailData.hydroMaster.product2 == 1 ? (
                      <FormControlLabel
                        value={1}
                        control={handleDisableRadio(
                          sig1.length > 0 && sig2.length > 0
                    ...
                    {props.jobDetailData.hydroMaster.product2 == 2 ? (
                      <FormControlLabel
                        value={2}
                        control={handleDisableRadio(
                          sig1.length > 0 && sig2.length > 0
                ...
                >
                  ...
                  >
                    {props.jobDetailData.hydroMaster.product3 == 1 ? (
                      <FormControlLabel
                        value={1}
                        control={handleDisableRadio(
                          sig1.length > 0 && sig2.length > 0
                    ...
                    {props.jobDetailData.hydroMaster.product3 == 2 ? (
                      <FormControlLabel
                        value={2}
                        control={handleDisableRadio(
                          sig1.length > 0 && sig2.length > 0
                ...
                >
                  ...
                  >
                    {props.jobDetailData.hydroMaster.product4 == 1 ? (
                      <FormControlLabel
                        value={1}
                        control={handleDisableRadio(
                          sig1.length > 0 && sig2.length > 0
                    ...
                    {props.jobDetailData.hydroMaster.product4 == 2 ? (
                      <FormControlLabel
                        value={2}
                        control={handleDisableRadio(
                          sig1.length > 0 && sig2.length > 0
                    ...
                    {props.jobDetailData.hydroMaster.product4 == 3 ? (
                      <FormControlLabel
                        value={3}
                        control={handleDisableRadio(
                          sig1.length > 0 && sig2.length > 0
                    ...
                    {props.jobDetailData.hydroMaster.product4 == 4 ? (
                      <FormControlLabel
                        value={4}
                        control={handleDisableRadio(
                          sig1.length > 0 && sig2.length > 0
            ...
            <Card className={classes.root} style={{ marginBottom: '15px' }}>
              <CardContent>
                ...
                <Grid container>
                  <Grid item xs={6}>
                    ...
                    >
                      ...
                      >
                        {props.jobDetailData.hydroMaster.technicalBefore1 ==
                        1 ? (
                          <FormControlLabel
                            value={1}
                            control={handleDisableRadio(
                ...
                <Grid container>
                  <Grid item xs={6}>
                    ...
                    >
                      ...
                      >
                        {props.jobDetailData.hydroMaster.technicalBefore21 ==
                        1 ? (
                          <FormControlLabel
                            value={1}
                            control={handleDisableRadio(
                  ...
                  <Grid item xs={6}>
                    ...
                    >
                      ...
                      >
                        {props.jobDetailData.hydroMaster.technicalAfter21 ==
                        1 ? (
                          <FormControlLabel
                            value={1}
                            control={handleDisableRadio(
                ...
                <Grid container>
                  <Grid item xs={6}>
                    ...
                    >
                      ...
                      >
                        {props.jobDetailData.hydroMaster.technicalBefore22 ==
                        1 ? (
                          <FormControlLabel
                            value={1}
                            control={handleDisableRadio(
                  ...
                  <Grid item xs={6}>
                    ...
                    >
                      ...
                      >
                        {props.jobDetailData.hydroMaster.technicalAfter22 ==
                        1 ? (
                          <FormControlLabel
                            value={1}
                            control={handleDisableRadio(
                ...
                <Grid container>
                  <Grid item xs={6}>
                    ...
                    >
                      ...
                      >
                        {props.jobDetailData.hydroMaster.technicalBefore31 ==
                        1 ? (
                          <FormControlLabel
                            value={1}
                            control={handleDisableRadio(
                ...
                <Grid container>
                  <Grid item xs={6}>
                    ...
                    >
                      ...
                      >
                        {props.jobDetailData.hydroMaster.technicalBefore32 ==
                        1 ? (
                          <FormControlLabel
                            value={1}
                            control={handleDisableRadio(
                ...
                <Grid container>
                  <Grid item xs={6}>
                    ...
                    >
                      ...
                      >
                        {props.jobDetailData.hydroMaster.technicalBefore33 ==
                        1 ? (
                          <FormControlLabel
                            value={1}
                            control={handleDisableRadio(
                ...
                <TextField
                  ...
                  multiline
                  rows={3}
                  value={props.jobDetailData.hydroMaster.description2}
                  placeholder="กรุณากรอกข้อมูล"
                          ...
                          <>
                            {props.jobDetailData.hydroMaster.signatureEmployee
                              ...
                              <>
                                ...
                                <Typography variant="h4">
                                  วันที่{' '}
                                  {/* {splitDate(props.hydroMaster.jobDate, 4, 2)} */}
                                  {props.dateShow}
                                </Typography>
                              </>
                            ) : null}
